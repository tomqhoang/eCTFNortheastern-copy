...
;
; Description: SHA256 hash functio (standard)
; Version 1 - July 2012.
;
; IMPORTANT NOTES
;
...
.MACRO XOR_ROTATE_RIGHT_7_18_3
	...
	RCALL ROTATE_BIT_TO_RIGHT_32_WR_A
	RCALL ROTATE_BIT_TO_RIGHT_32_WR_A
...
.MACRO XOR_ROTATE_RIGHT_2_13_22
	...
	; rotate 3 bits right
	RCALL ROTATE_BIT_TO_RIGHT_32_WR_B
	RCALL ROTATE_BIT_TO_RIGHT_32_WR_B
	RCALL ROTATE_BIT_TO_RIGHT_32_WR_B
...
; SUBFUNCTION FOR MACROS: ROTATE WORKING REGISTER A (32 BIT WORD) TO RIGHT BY ONE BIT
; INPUT: WR_A
; DESTROYS: TEMP_REG
; OUTPUT: WR_A
ROTATE_BIT_TO_RIGHT_32_WR_A:
...
; SUBFUNCTIONS FOR MACROS: ROTATE WORKING REGISTER B (32 BIT WORD) TO RIGHT BY ONE BIT
; INPUT: WR_B
; DESTROYS: TEMP_REG
; OUTPUT: WR_B
ROTATE_BIT_TO_RIGHT_32_WR_B:
